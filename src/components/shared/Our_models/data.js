...
export const Data = (language) => [
  ...
  //               defaultMessage="Logo | Brand Identity"
  //             />
  //           ),
  //         },
  //       ],
  ...
  //           text: (
  //             <FormattedMessage
  //               id="social-media-campaign-design"
  //               defaultMessage="Social Media Campaign Design"
  //             />
  //           ),
  //         },
  //       ],
  ...
  //           text: (
  //             <FormattedMessage
  //               id="game-design-3d-artwork"
  //               defaultMessage="Game Design | 3D Artwork"
  //             />
  //           ),
  //         },
  //       ],
